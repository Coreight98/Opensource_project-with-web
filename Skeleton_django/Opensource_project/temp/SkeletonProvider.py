...
if __name__ == '__main__':
    ...
    parser.add_argument('--proto', type=str, default='/Users/maxcha/PycharmProjects/pythonProject/Skeleton_django/Opensource_project/temp/pose/coco/pose_deploy_linevec.prototxt', help='for model. default pose/coco/pose_deploy_linevec.prototxt')
    parser.add_argument('--weight', type=str, default='/Users/maxcha/PycharmProjects/pythonProject/Skeleton_django/Opensource_project/temp/pose/coco/pose_iter_440000.caffemodel', help='for model. default pose/coco/pose_iter_440000.caffemodel')
