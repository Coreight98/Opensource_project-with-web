...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', type=str, default='../output', help='output gsource path, until filename(format exclude). default output')
    ...
    parser.add_argument('--proto', type=str, default='CV_skeleton_provider/pose/coco/pose_deploy_linevec.prototxt', help='for model. default pose/coco/pose_deploy_linevec.prototxt')
    parser.add_argument('--weight', type=str, default='CV_skeleton_provider/pose/coco/pose_iter_440000.caffemodel', help='for model. default pose/coco/pose_iter_440000.caffemodel')
